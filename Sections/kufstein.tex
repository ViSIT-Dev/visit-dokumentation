...
Im Browser öffnet sich nun die Webseite und im oberen rechten Eck ist das sogenannte Kuratorenkästchen eingeblendet. In diesem werden die x- und y-Koordinaten der aktuellen Position des Fernrohrs und die bereits bestehenden Punkte angezeigt.
...
Die beide Überschriften werden nur benötigt, wenn es sich um einen Texttyp handelt. Bei Videos reicht nur eine Überschrift. Als nächstes muss die Position eingetragen werden. Hier müssen die zuvor notierten x- und y-Koordinaten eingetragen werden (siehe Abbildung \ref{img:fernrohr_x_u_y_koordinaten}. Handelt es sich um ein Fullscreen Video, dann muss das Häckchen daneben gesetzt werden. Als nächstes können Medien hinzugefügt werden.

\subsection{Radius der POI's}
