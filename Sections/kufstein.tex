...
Wenn jetzt die Web-Ansicht über Rechtsklick auf Fernrohr im Seitenbaum und \glqq Show\grqq{} auswählen (siehe Abbildung \ref{img:fernrohr_webansicht_oeffnen} geöffnet wird, dann ist rechts oben ein großes Kästchen mit einigen Daten sichtbar (siehe Abbildung \ref{img:fernrohr_webansicht_debugmodus} der blaue Hintergrund ist im Produktivbetrieb eine Landkarte oder Landschaft).
