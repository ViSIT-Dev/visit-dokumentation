...
im API Project: ab und an erkennt er die abhängigkeiten aus irgendeinem grund nicht -> zur parent pom.xml gehen und reimport maven dependencies drücken, nach kurzer dauer sollte das dann wieder funktionieren
