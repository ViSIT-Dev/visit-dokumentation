...
% Own convenience shortcuts
\newcommand{\visit}[0]{ViSIT }
\newcommand{\wisski}[0]{WissKI }

\usepackage{listings}

\definecolor{theBlack}{gray}{0.0}

% Querseite/Querbilder
\usepackage{rotating}

% LstListing RDF style
\lstset{
language=XML, 
numbers=left,
stepnumber=1,
numberstyle=\tiny,
basicstyle=\color{theBlack}\scriptsize\ttfamily,
commentstyle=\color{theBlack},
keywordstyle=\color{theBlack},
identifierstyle=\color{theBlack},
stringstyle=\color{theBlack},
keywords={},
